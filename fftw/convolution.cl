// ------ language="OpenCL" file="convolution.cl"
// ------ begin <<convolution-dimensions>>[0]
...
// ------ end
// ------ begin <<convolution-parameters>>[0]
#ifndef block_size_x
...
// ------ begin <<naive-convolution-kernel>>[0]
